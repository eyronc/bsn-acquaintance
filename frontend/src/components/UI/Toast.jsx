...
export function Toast({ message, type = 'success', onClose, duration = 3500 }) {
  ...
  return (
    <div className="no-print fixed bottom-4 left-4 right-4 sm:left-auto sm:right-6 sm:bottom-6 sm:max-w-md z-50 flex items-start gap-3 p-3.5 bg-white/95 backdrop-blur-md neu-flat-lg rounded-2xl border border-[var(--neu-border)] shadow-2xl animate-toast-enter text-[var(--neu-text)]">
      {icons[type]}
