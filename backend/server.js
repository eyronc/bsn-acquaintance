  ...
  try {
    ...
    const emailHtml = `
      ...
      <head>
        ...
        <style>
          @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700&family=Poppins:wght@600;700&family=Plus+Jakarta+Sans:wght@400;500;600&family=Roboto:wght@600;700&family=Inter:wght@400;500;600&display=swap');
        </style>
      </head>
              ...
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 580px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 15px 35px rgba(219, 39, 119, 0.12); border: 1px solid #fbcfe8;">
                ...
                <tr>
                  <td style="background: linear-gradient(135deg, #3b1427 0%, #581c37 50%, #831843 100%); padding: 32px 30px 24px 30px; text-align: center; color: #ffffff;">
                    ...
                    <div style="display: inline-block; background: rgba(244, 114, 182, 0.2); border: 1px solid rgba(244, 114, 182, 0.4); border-radius: 50px; padding: 6px 16px; margin-bottom: 16px;">
                      <span style="color: #fbcfe8; font-size: 11px; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">Official Event Pass</span>
                    </div>
                ...
                <tr>
                  <td style="padding: 36px 30px 20px 30px;">
                    ...
                    <div style="background: linear-gradient(135deg, #fff1f2 0%, #ffe4e6 100%); border: 2px dashed #f472b6; border-radius: 20px; padding: 28px 20px; text-align: center; margin-bottom: 30px;">
                      <p style="margin: 0 0 10px 0; color: #831843; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.2px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">Your Unique Access Code</p>
                      ...
                      <div style="background: #ffffff; border-radius: 14px; padding: 16px 20px; display: inline-block; box-shadow: inset 0 2px 4px rgba(0,0,0,0.04), 0 4px 12px rgba(244, 114, 182, 0.15); margin-bottom: 16px;">
                        <code style="font-family: 'Roboto', monospace; font-size: 32px; font-weight: 600; color: #db2777; letter-spacing: 5px; display: block;">${unique_code}</code>
                      </div>

                      <div>
                        <a href="${eventUrl}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #ec4899 0%, #be185d 100%); color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; padding: 12px 28px; border-radius: 12px; box-shadow: 0 6px 18px rgba(236, 72, 153, 0.35); font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">
                    ...
                    <div style="background: #fdf2f7; border-radius: 18px; padding: 24px; border: 1px solid #fbcfe8; margin-bottom: 24px;">
                      <h3 style="margin: 0 0 16px 0; color: #3b1427; font-size: 15px; font-weight: 600; font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">
                      ...
                      <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="28" valign="top" style="padding-bottom: 12px;">
                            <span style="background: #ec4899; color: #ffffff; font-size: 11px; font-weight: 600; letter-spacing: 1px; width: 20px; height: 20px; border-radius: 50%; display: inline-block; text-align: center; line-height: 20px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">1</span>
                          </td>
                          <td style="padding-bottom: 12px; color: #4c0519; font-size: 13px; line-height: 1.5; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                        ...
                        <tr>
                          <td width="28" valign="top" style="padding-bottom: 12px;">
                            <span style="background: #ec4899; color: #ffffff; font-size: 11px; font-weight: 600; letter-spacing: 1px; width: 20px; height: 20px; border-radius: 50%; display: inline-block; text-align: center; line-height: 20px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">2</span>
                          </td>
                          <td style="padding-bottom: 12px; color: #4c0519; font-size: 13px; line-height: 1.5; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                            Enter email: <code style="background: #ffffff; border: 1px solid #fbcfe8; padding: 2px 8px; border-radius: 6px; color: #be185d; font-weight: 600; font-family: 'Roboto', monospace; letter-spacing: 0.5px;">${email}</code>
                          </td>
                        </tr>
                        <tr>
                          <td width="28" valign="top" style="padding-bottom: 12px;">
                            <span style="background: #ec4899; color: #ffffff; font-size: 11px; font-weight: 600; letter-spacing: 1px; width: 20px; height: 20px; border-radius: 50%; display: inline-block; text-align: center; line-height: 20px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">3</span>
                          </td>
                          <td style="padding-bottom: 12px; color: #4c0519; font-size: 13px; line-height: 1.5; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                            Enter Access Code: <code style="background: #ffffff; border: 1px solid #fbcfe8; padding: 2px 8px; border-radius: 6px; color: #be185d; font-weight: 600; font-family: 'Roboto', monospace; letter-spacing: 0.5px;">${unique_code}</code>
                          </td>
                        </tr>
                        <tr>
                          <td width="28" valign="top">
                            <span style="background: #ec4899; color: #ffffff; font-size: 11px; font-weight: 600; letter-spacing: 1px; width: 20px; height: 20px; border-radius: 50%; display: inline-block; text-align: center; line-height: 20px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">4</span>
                          </td>
                          <td style="color: #4c0519; font-size: 13px; line-height: 1.5; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                ...
                <tr>
                  <td style="background: #fdf2f7; padding: 24px 30px; text-align: center; border-top: 1px solid #fbcfe8;">
                    <p style="margin: 0 0 6px 0; color: #831843; font-size: 13px; font-weight: 600; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">We look forward to seeing you!</p>
                    <p style="margin: 0; color: #9f1239; font-size: 11px; font-weight: 500; letter-spacing: 0.2px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">UCLM College of Nursing • BSN Acquaintance Party 2026</p>
                  </td>
                </tr>
          ...
          <tr>
            <td align="center">
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 580px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 15px 35px rgba(219, 39, 119, 0.12); border: 1px solid #fbcfe8;">
                ...
                <tr>
                  <td style="background: linear-gradient(135deg, #065f46 0%, #047857 50%, #3b1427 100%); padding: 32px 30px 24px 30px; text-align: center; color: #ffffff;">
                    ...
                    <div style="display: inline-block; background: rgba(52, 211, 153, 0.25); border: 1px solid rgba(52, 211, 153, 0.4); border-radius: 50px; padding: 6px 16px; margin-bottom: 16px;">
                      <span style="color: #a7f3d0; font-size: 11px; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase; font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">SEAT RESERVATION CONFIRMED</span>
                    </div>
                    <h1 style="margin: 0; font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif; font-size: 26px; font-weight: 700; letter-spacing: -0.5px; color: #ffffff; line-height: 1.2;">
                      BSN Acquaintance Party 2026
                    </h1>
                ...
                <tr>
                  <td style="padding: 36px 30px 20px 30px;">
                    ...
                    <div style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border: 2px solid #10b981; border-radius: 20px; padding: 28px 20px; text-align: center; margin-bottom: 30px; box-shadow: 0 8px 20px rgba(16, 185, 129, 0.12);">
                      <p style="margin: 0 0 12px 0; color: #065f46; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.2px; font-family: 'Poppins', system-ui, -apple-system, sans-serif;">Your Reserved Seat Location</p>
                      ...
                      <div style="display: inline-block; background: #ffffff; border-radius: 16px; padding: 18px 28px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.15); border: 1px solid #a7f3d0; margin-bottom: 16px;">
                        <span style="font-family: 'Roboto', monospace; font-size: 28px; font-weight: 600; color: #047857; letter-spacing: 2.5px;">
                          TABLE ${table_number} &bull; SEAT ${seat_number}
                        </span>
                      </div>

                      <div>
                        <a href="${eventUrl}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #10b981 0%, #047857 100%); color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; padding: 12px 28px; border-radius: 12px; box-shadow: 0 6px 18px rgba(16, 185, 129, 0.35); font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">
                          View Seat Map →
                        </a>
                      </div>
                    </div>
                    ...
                    <div style="background: #fdf2f7; border-radius: 18px; padding: 24px; border: 1px solid #fbcfe8; margin-bottom: 24px; text-align: center;">
                      <h3 style="margin: 0 0 8px 0; color: #3b1427; font-size: 16px; font-weight: 600; font-family: 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif;">
                        See You at the Event!
                      </h3>
                      <p style="margin: 0 0 12px 0; color: #831843; font-size: 13px; line-height: 1.6; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                        Your seat is officially locked in. Please keep this email as your digital pass for entry at the event.
                      </p>
                      <p style="margin: 0; color: #be185d; font-size: 12px; font-weight: 600; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">
                ...
                <tr>
                  <td style="background: #fdf2f7; padding: 24px 30px; text-align: center; border-top: 1px solid #fbcfe8;">
                    <p style="margin: 0 0 6px 0; color: #047857; font-size: 13px; font-weight: 600; letter-spacing: 0.3px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">Get ready for an unforgettable night!</p>
                    <p style="margin: 0; color: #831843; font-size: 11px; font-weight: 500; letter-spacing: 0.2px; font-family: 'Plus Jakarta Sans', system-ui, -apple-system, sans-serif;">UCLM College of Nursing • BSN Acquaintance Party 2026</p>
                  </td>
                </tr>
